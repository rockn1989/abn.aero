$(function () {
	...
	var videoGallery = $('.video-slider .slider').on('init', function (event, slick) {
	...
	videoGallery.slick({
		...
		customPaging: function (slider, i) {
			return '<button><svg viewBox="0 0 120 120" version="1.1"xmlns="http://www.w3.org/2000/svg" class="btn-circle"><circle style="fill: none; stroke: #ff9d00; stroke-width: 6px;" cx="60" cy="60" r="50"/></svg></button>';
		},
	});
