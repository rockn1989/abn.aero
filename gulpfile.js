...
const watch = () => {
	...
	gulp.watch("assets/img/**/*", gulp.series(template, cleanFolderImage, copyImages));
	gulp.watch(
...
//clean;
const cleanFolderImage = () => {
	return gulp.src("./dist/img", { allowEmpty: true }).pipe(clean({ read: false }));
};

exports.cleanFolderImage = cleanFolderImage;
